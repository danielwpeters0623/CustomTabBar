...
struct ContentView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            case .home:
                //This transitions everything to the view
                Text("Home")
            case .liked:
                Text("Liked")
            case .records:
            ...
            HStack {
                ...
                TabBarIcon(viewRouter: viewRouter, assignedPage: .users,width: geometry.size.width/5, height: geometry.size.height/28, systemIconName: "person.crop.circle", tabName: "Account")
...
struct PlusMenu: View {
    ...
    //This is what happens when you click on the plus size
